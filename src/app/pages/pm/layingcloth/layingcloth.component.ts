...
declare var $: any;
@Component({
  selector: 'app-layingcloth',
  templateUrl: './layingcloth.component.html',
  styleUrls: ['./layingcloth.component.css']
})
export class LayingClothComponent extends ListTemplateComponent {
  ...
  constructor(public router: Router, private fb: FormBuilder,) {
    super();
    this.modularInit("pmLayingcloth");
