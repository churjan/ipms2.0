...
import { ClearanceManagementService } from '~/pages/warehouse/wms/clearance-management/clearance-management.service';
...
@Component({
    ...
    templateUrl: './clearance-management.component.html',
    styleUrls: ['./clearance-management.component.less']
})
export class clearanceManagementComponent extends ListTemplateComponent {
    ...
    constructor(public router: Router,
        public clearanceManagementService: ClearanceManagementService,
