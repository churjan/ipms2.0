...
@Component({
    selector: 'Qualitytracking-Custom',
    templateUrl: './Qualitytracking-Custom.component.html',
    styleUrls: ['./Qualitytracking-Custom.component.less']
})
export class QualityTrackingCustomComponent extends ListTemplateComponent {
